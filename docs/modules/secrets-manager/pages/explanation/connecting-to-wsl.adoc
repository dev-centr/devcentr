...
For choosing **which** Linux distribution to run under WSL (default vs specialists), see xref:general-knowledge:explanation/infrastructure/wsl-distro-comparison.adoc[Choosing a WSL Linux Distro] and the DevCentr **WSL** page (xref:specifications:components/wsl-manager.adoc[WSL Manager]).
