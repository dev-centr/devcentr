...
* The local workspace layout under `$ROOT` (see xref:knowledge-base:reference/workspace-organization.adoc[Workspace Organization]).
...
* The global remote naming conventions described in xref:knowledge-base:reference/git-management.adoc[Git Management].
