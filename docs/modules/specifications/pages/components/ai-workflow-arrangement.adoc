...
This is the **`ai-stack` domain pack** of the generic xref:components/role-topology-composer.adoc[Role Topology Composer]. Prefer generic composer terms in shared code; this page is the AI-facing product behavior.
...
* xref:components/role-topology-composer.adoc[Role Topology Composer] — generic system
* xref:components/ai-config-interface.adoc[AI Config Interface] — Providers / MCP / Skills; Arrangement opens this pack’s canvas
* xref:components/agent-shell-registry.adoc[Agent Shell Registry] — products + arrangements as layout recipes
* xref:components/repository-browser-terminal.adoc[Repository Browser Terminal] — fixed `human-shell` product
