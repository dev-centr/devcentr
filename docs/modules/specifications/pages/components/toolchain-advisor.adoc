...
* xref:components/installation-workflow.adoc[Installation Workflow] — installing runtimes after a toolchain is chosen.
* xref:reference/definition-files.adoc[Definition Files] — service/language definitions for install offers.
* Secrets Manager xref:platforms:secrets-manager:explanation/connecting-to-wsl.adoc[Connecting to WSL] — paths and bridges when WSL is part of the workflow.
