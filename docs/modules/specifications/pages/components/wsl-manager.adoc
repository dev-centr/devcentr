...
| Primary surface. Lives in DevCentr so Stack Advisor, Secrets/SSH, and docs links stay one hop away. Matches “environment navigator” product direction.
...
* xref:components/toolchain-advisor.adoc[Stack Advisor] (WSL as a host option)
