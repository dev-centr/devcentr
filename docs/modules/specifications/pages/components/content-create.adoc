...
* **File manager:** *DevCentr* menu → *New File…* / *New Project…* / *Open folder* — Win11 modern menu preferred, classic/Linux adapters as fallback (see xref:components/explorer-shell-integration.adoc[Explorer Shell Integration]).
