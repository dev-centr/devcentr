...
* **Windows Explorer:** Cascading *DevCentr* menu → *New File…* / *New Project…* / *Open folder* (see xref:explorer-shell-integration.adoc[Explorer Shell Integration]).
* **CLI:** `dev-center.exe --mode=new-file --path=<dir> [--tags=general,java]` (also `new-project`, `open`).
