...
Registration assistance can follow the patterns described in the xref:knowledge-base:explanation/infrastructure/iac.adoc[Infrastructure as Code (IaC)] doc (organization use):
...
* xref:knowledge-base:explanation/infrastructure/iac.adoc[Infrastructure as Code (IaC)] — OpenTofu, **personal use (repo-level)** vs **organization use**, delegation patterns (Docs button target).
