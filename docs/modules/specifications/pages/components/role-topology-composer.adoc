...
The first instance is the AI agent stack (xref:components/ai-workflow-arrangement.adoc[AI Workflow Arrangement]). The same composer should later serve other domains that have a real stack/layer spine — without renaming the core UI to AI terms.
...
* **AI stack** — xref:components/ai-workflow-arrangement.adoc[AI Workflow Arrangement] (this pack)
