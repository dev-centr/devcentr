...
** The detection logic is backed by the same tool metadata used in xref:knowledge-base:reference/recommended-tools.adoc[Recommended Development Tools].
* The dialog includes a link to:
** xref:knowledge-base:reference/git-guis.adoc[Git GUIs and Visual History Browsers].
