...
`Arrangement` opens the **AI stack topology canvas** (Role Topology Composer, `ai-stack` pack): blank map landing, layout recipes, and **Add an AI tool…** guided add. Full behavior: xref:ai-workflow-arrangement.adoc[AI Workflow Arrangement] and xref:role-topology-composer.adoc[Role Topology Composer].
...
* xref:ai-workflow-arrangement.adoc[AI Workflow Arrangement] / xref:role-topology-composer.adoc[Role Topology Composer] — Arrangement tab opens the AI stack canvas (not a one-shot wizard; guided add is separate)
* xref:agent-shell-registry.adoc[Agent Shell Registry] supplies arrangement ids and shopping data.
