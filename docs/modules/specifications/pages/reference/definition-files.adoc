...
* **Purpose:** Top-level asset classifications (docs, config, code, plaintext), nested subtype trees, stub templates, and orthogonal **lineage** graphs (evolution / supersession / specialization) for the Create… dialog.
