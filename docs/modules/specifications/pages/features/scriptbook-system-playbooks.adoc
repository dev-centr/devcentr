...
Essay::
link:https://devcentr.org/blog/2026-08-13-stop-translating-shells[Stop translating shells]
...
Details: xref:tools:scriptbook:playtime.adoc[PlayTime] · xref:tools:scriptbook:host-awareness.adoc[Host Awareness] · GitHub `spec/` until the hub deploy lands.
