...
* xref:specifications:components/uniconfig.adoc[UniConfig Config Panel] — integration spec in `DevCentr`; product docs in xref:tools:uniconfig:index.adoc[uniconfig] at v0.1.
...
* xref:tools:uniconfig:reference.adoc[UniConfig reference (product versioning today)]
