...
This technical specification describes **Prohelp** — progressive command-line help. The system delivers a professional-grade terminal documentation experience; the product name stays short on purpose.

**Canonical repository:** link:https://github.com/openshellorg/prohelp[openshellorg/prohelp] (moved from Dev-Centr into OpenShellOrg). This page remains a Dev-Centr consumer copy of the specification; prefer the OpenShellOrg README and sources for implementation truth.
