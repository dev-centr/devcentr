...
* xref:knowledge-base:how-to/git-release-workflow.adoc[Git Release Workflow] — When and how to treat work as a "release" (general guide)
* xref:knowledge-base:how-to/automated-releases.adoc[Automated Releases] — Building and attaching binaries with GitHub Actions (general guide)
* xref:vercel-deployment.adoc[Vercel Monorepo Deployment] — Configuring Root Directories and handling build script asymmetry
* xref:knowledge-base:reference/package-registries.adoc[Package Registries] — Choosing where to publish (ecosystem registries, GitHub, package managers)
