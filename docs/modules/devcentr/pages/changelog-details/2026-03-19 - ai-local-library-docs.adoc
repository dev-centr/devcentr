...
* Updated xref:devcentr:ai-local-library-docs.adoc[AI Local Library Docs] to define the layered source priority: MCP-hosted indexed docs such as Context7 first, repo-local cloned docs/source second, web search last.
