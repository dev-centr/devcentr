...
3. Deleted the stale `local-overrides.json`. Prefer `dub add-local` for any future local package registration (see xref:devcentr:dub-local-remote-paths.adoc[DUB Local vs Remote Paths]).
